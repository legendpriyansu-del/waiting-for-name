...
const TARGET_DATE = /* @__PURE__ */ new Date("2027-02-14T00:00:00");
...
function createHeart(W, H, randomY = false) {
  const h = {
    x: Math.random() * W,
    ...
    wobbleSpeed: Math.random() * 0.02 + 5e-3,
    rot: Math.random() * 0.6 - 0.3,
    rotSpeed: (Math.random() - 0.5) * 8e-3,
    opacity: 0,
...
function App() {
  ...
  const cursorDotRef = reactExports.useRef(null);
  const cursorRingRef = reactExports.useRef(null);
  const btnAreaRef = reactExports.useRef(null);
  const noBtnRef = reactExports.useRef(null);
  const yesBtnRef = reactExports.useRef(null);
  const finaleRef = reactExports.useRef(null);
  const introRef = reactExports.useRef(null);
  const envelopeRef = reactExports.useRef(null);
  const progressWrapRef = reactExports.useRef(null);
  const dotsContainerRef = reactExports.useRef(null);
  const typewriterRef = reactExports.useRef(null);
  const fineBoxRef = reactExports.useRef(null);
  const audioRef = reactExports.useRef(null);
  const [cur, setCur] = reactExports.useState(-1);
  const [fine, setFine] = reactExports.useState(0);
  const [attempts, setAttempts] = reactExports.useState(0);
  const [distEscaped, setDistEscaped] = reactExports.useState(0);
  const [showFineSection, setShowFineSection] = reactExports.useState(false);
  const [showStats, setShowStats] = reactExports.useState(false);
  const [showFinale, setShowFinale] = reactExports.useState(false);
  const [twText, setTwText] = reactExports.useState("");
  const [isPlaying, setIsPlaying] = reactExports.useState(false);
  const [showMusicTooltip, setShowMusicTooltip] = reactExports.useState(false);
  const [countdown, setCountdown] = reactExports.useState(getCountdown());
  const [showShareToast, setShowShareToast] = reactExports.useState(false);
  const twDoneRef = reactExports.useRef(false);
  const isTypingRef = reactExports.useRef(false);
  const heartsRef = reactExports.useRef([]);
  const animFrameRef = reactExports.useRef(0);
  const cursorAnimRef = reactExports.useRef(0);
  const rxRef = reactExports.useRef(0);
  const ryRef = reactExports.useRef(0);
  const mxRef = reactExports.useRef(0);
  const myRef = reactExports.useRef(0);
  const fineRef = reactExports.useRef(0);
  const attemptsRef = reactExports.useRef(0);
  const distRef = reactExports.useRef(0);
  const noLeft = reactExports.useRef("calc(50% + 90px)");
  const noTop = reactExports.useRef("calc(50% + 25px)");
  const [noBtnPos, setNoBtnPos] = reactExports.useState({
    left: "calc(50% + 90px)",
    top: "calc(50% + 25px)"
  });
  const [noBtnScale, setNoBtnScale] = reactExports.useState(1);
  const [noBtnOpacity, setNoBtnOpacity] = reactExports.useState(1);
  const [yesShake, setYesShake] = reactExports.useState(false);
  const [fineFlash, setFineFlash] = reactExports.useState(false);
  const [fineMsg, setFineMsg] = reactExports.useState(
    "Hint: just click Yes and save yourself some money 😊"
  );
  const [statAttempts, setStatAttempts] = reactExports.useState(0);
  const [statDist, setStatDist] = reactExports.useState("0px");
  const [statPat, setStatPat] = reactExports.useState("100%");
  const [statPatColor, setStatPatColor] = reactExports.useState("var(--green)");
  const [toasts, setToasts] = reactExports.useState([]);
  const toastCountRef = reactExports.useRef(0);
  const curSlideRef = reactExports.useRef(-1);
  reactExports.useEffect(() => {
  ...
  const startTypewriter = reactExports.useCallback(() => {
  ...
  const go = reactExports.useCallback(
    (index2) => {
      if (index2 < 0 || index2 >= TOTAL) return;
      if (curSlideRef.current === 0 && index2 !== 0) {
        isTypingRef.current = false;
      }
      curSlideRef.current = index2;
      setCur(index2);
      const pf = document.getElementById("progressFill");
      if (pf) pf.style.width = `${index2 / (TOTAL - 1) * 100}%`;
      if (index2 === 0) {
  ...
  const openEnvelope = reactExports.useCallback(() => {
  ...
  const toggleMusic = reactExports.useCallback(() => {
  ...
  const shareFinale = reactExports.useCallback(() => {
  ...
  const runAway = reactExports.useCallback(() => {
  ...
  const sayYes = reactExports.useCallback(() => {
    setShowFinale(true);
    const pf = document.getElementById("progressFill");
  ...
  const slideActive = (i) => cur === i;
  const CheckIcon = () => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "svg",
    {
      width: "16",
      height: "16",
  ...
  const ArrowIcon = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      width: "16",
      height: "16",
  ...
  const HeartFillIcon = () => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "svg",
    {
      width: "14",
      height: "14",
  ...
  const CountdownPill = ({
    value,
    label
  }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "countdown-pill", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "countdown-num", children: String(value).padStart(2, "0") }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "countdown-label", children: label })
  ] });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cursor-dot", ref: cursorDotRef }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cursor-ring", ref: cursorRingRef }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("canvas", { id: "heartCanvas", ref: canvasRef }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "music-btn-wrap", "data-ocid": "music-toggle", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      showMusicTooltip && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "music-tooltip", children: isPlaying ? "Pause music" : "Click to play music" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "intro", ref: introRef, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "star-field", children: stars.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "star",
          style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "envelope-flap" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "envelope-body" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "letter serif", style: { fontStyle: "italic" }, children: "For you..." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "tap-hint", children: "tap the envelope to open" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: { opacity: 0, transition: "opacity 0.5s ease" },
        children: DOT_LABELS.map((label, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
    ...
    toasts.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "toast", children: t.msg }, t.id)),
    showShareToast && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "toast toast-share", "data-ocid": "share-toast", children: "Link copied! Share the love 💕" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `slide${slideActive(0) ? " active" : ""}`, id: "s0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-image", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overlay" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "slide-inner text-center px-6 max-w-3xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "mb-8",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "A Present for My Babyyy😙"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "h1",
          {
            ...
            style: {
              background: "linear-gradient(135deg,#fff 0%,rgba(96,165,250,0.9) 50%,rgba(192,132,252,0.9) 100%)",
            ...
            children: [
              twText,
              cur === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tw-cursor" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "Before you go any further, I need you to know —"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "every single word that follows was written with a full heart."
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: "btn-next", onClick: () => go(1), children: [
          "Take my hand ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowIcon, {})
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `slide${slideActive(1) ? " active" : ""}`, id: "s1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "slide-inner px-6 max-w-5xl mx-auto w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center gap-10 md:gap-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              animation: "photoIn 0.7s cubic-bezier(0.16,1,0.3,1) 0.2s forwards",
              opacity: 0,
              "--rot": "-2deg"
            },
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cap", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "the day everything changed" }) })
            ]
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left max-w-md", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              ...
              style: {
                background: "linear-gradient(to right,#fff,rgba(96,165,250,0.85))",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent"
              },
              children: "When I First Saw You"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "p",
            {
              ...
              children: [
                "I remember that exact moment. My heart did something it had never done before — it",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "rgba(255,255,255,0.7)" }, children: "skipped a beat" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: "text-base leading-relaxed mb-4",
              style: { color: "rgba(255,255,255,0.4)", lineHeight: 1.8 },
              children: "Your smile, your laugh, the way you carried yourself — like the whole world was a stage and you didn't even know it."
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              style: { color: "rgba(255,255,255,0.6)" },
              children: "I didn't know it then, but that was the moment my life truly began."
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center md:justify-start", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              className: "btn-next",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `slide${slideActive(2) ? " active" : ""}`, id: "s2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "aurora-orb",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "slide-inner px-6 max-w-4xl mx-auto text-center w-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            className: "text-xs uppercase mb-4",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h2",
          {
            ...
            style: {
              background: "linear-gradient(to right,#fff,rgba(168,85,247,0.85))",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent"
            },
            children: "Things I Love About You"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            id: "traitGrid",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "trait", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "icon-wrap",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Your Smile" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "My favorite thing in the entire universe. It could cure sadness in a heartbeat." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "trait", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Your Mind" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The way you think, the way you see the world — it inspires me every single day." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "trait", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Your Kindness" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "You care so deeply about everyone around you. Your heart is pure gold." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "trait", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Your Laugh" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "That real, unfiltered laugh — I'd move mountains just to hear it one more time." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "trait", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Your Smell" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "yayyyyyyy" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "trait", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Just... You" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Everything. Every little thing. Even what you think are flaws — I love those most." })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: "btn-next", onClick: () => go(3), children: [
          "There's more... ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowIcon, {})
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `slide${slideActive(3) ? " active" : ""}`, id: "s3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "aurora-orb",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "slide-inner px-6 max-w-5xl mx-auto w-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              ...
              style: {
                background: "linear-gradient(to right,#fff,rgba(236,72,153,0.85))",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent"
              },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Every moment with you is a memory I treasure more than anything."
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 mb-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: "btn-next", onClick: () => go(4), children: [
          "Almost there... ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowIcon, {})
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `slide${slideActive(4) ? " active" : ""}`, id: "s4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-image", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "slide-inner px-6 max-w-3xl mx-auto text-center relative z-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            className: "text-xs uppercase mb-4",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h2",
          {
            ...
            style: {
              background: "linear-gradient(to right,#fff,rgba(52,211,153,0.85))",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent"
            },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-left max-w-lg mx-auto mb-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "promise", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckIcon, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "I promise to always make you laugh, even on your worst days." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "promise", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckIcon, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "I promise to be your shelter in every storm life throws at us." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "promise", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckIcon, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "I promise to choose you — every morning, every day, for the rest of my life." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "promise", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckIcon, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "I promise to never stop surprising you, never stop growing with you, never take you for granted." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "promise", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckIcon, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "I promise that our love story will be my greatest masterpiece." })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `slide${slideActive(5) ? " active" : ""}`, id: "s5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "aurora-orb",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "slide-inner text-center px-6 max-w-2xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ring-pedestal mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ring-big", children: "💍" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h2",
          {
            className: "serif text-4xl md:text-6xl font-normal tracking-tight mb-4 leading-tight",
            style: {
              background: "linear-gradient(135deg,#fff 0%,rgba(96,165,250,0.9) 35%,rgba(168,85,247,0.9) 65%,rgba(236,72,153,0.9) 100%)",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent"
            },
            children: "Will You Marry Me?"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            style: { color: "rgba(255,255,255,0.3)" },
            children: "There's only one right answer... and my code won't let you choose wrong. 😏"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  onClick: sayYes,
                  style: {
                    animation: yesShake ? "shake 0.35s ease" : "btnGrad 4s ease infinite,pulseGlow 3s ease-in-out infinite"
                  },
        ...
        showFineSection && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "fineSec", className: "mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    children: '⚠️ Fine for attempting "No":'
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "fine-amount", children: [
                  "$",
                  fine.toLocaleString()
                ] })
              ]
        ...
        showStats && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-3 max-w-xs mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "finale", ref: finaleRef, className: showFinale ? "show" : "", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fin-inner text-center px-6 max-w-2xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ring-glow-wrap mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ring-big", children: "💍" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h1",
        {
          ...
          style: {
            ...
            background: "linear-gradient(135deg,rgba(96,165,250,1),rgba(168,85,247,1),rgba(236,72,153,1),rgba(245,158,11,1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
          },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: "You just made me the happiest person alive. From this moment, every sunrise belongs to us, every dream is ours to chase, and every chapter — we write together."
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center flex-wrap gap-1 mb-10", children: [
        {
          icon: "💍",
      ...
      ].map((item, i, arr) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "timeline-item", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
        ...
        i < arr.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "timeline-line mx-1" })
      ] }, item.label)) }),
      fine > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "rgba(96,165,250,0.6)", fontSize: "13px" }, children: "💰 Fine accumulated:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "rgba(96,165,250,0.5)", fontSize: "12px" }, children: "(Payable in kisses 😘)" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "quote-box max-w-md mx-auto mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            className: "serif italic text-lg leading-relaxed",
            style: { color: "rgba(255,255,255,0.55)" },
            children: '"In all the world, there is no heart for me like yours. In all the world, there is no love for you like mine."'
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "— Maya Angelou"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "countdown-wrap mb-8", "data-ocid": "countdown-timer", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "countdown-title", children: "Counting every moment with you" }),
        countdown.passed ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "countdown-passed", children: "Every moment together ✨" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "countdown-grid", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CountdownPill, { value: countdown.days, label: "days" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CountdownPill, { value: countdown.hours, label: "hrs" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CountdownPill, { value: countdown.minutes, label: "min" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CountdownPill, { value: countdown.seconds, label: "sec" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "countdown-subtitle", children: "Until Valentine's Day 2027 💕" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-10", "data-ocid": "share-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          className: "btn-share",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(HeartFillIcon, {}),
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Forever & always, yours" }),
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(HeartFillIcon, {})
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: "11px", color: "rgba(255,255,255,0.08)" }, children: "Made with 💙 and a lot of nervousness" })
    ] }) })
  ] });
}
